...
class Gui:
    ...
    def __init__(self):
        ...
        WindowLabel.configure(background="White", foreground="blue", font=("Comic Sans MS", 24, "bold"))
        ...
        RB1.configure(font=("Comic Sans MS", 20, "bold"))
